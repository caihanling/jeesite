...
<head>
	...
	<script type="text/javascript">
		...
		var tree, 
		setting = {
				view:{selectedMulti:false,dblClickExpand:false},	//禁止多点选中,双击不展开父节点  
				check:{enable:"${checked}",nocheckInherit:true},	//是否使用选框和按钮，自动集成父节点的nocheck属性
				async:{enable:(type==3),							//是否开启异步加载模式
				url:"${ctx}/sys/user/treeData",autoParam:["id=officeId"]},		//重命名参数的名称
				data:{simpleData:{enable:true}},					//树的节点，接受简单的数据模式
				callback:{<%--
